...
export type QuerySearchPlanetsArgs = {
  name: Scalars['String'];
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  SearchPlanets?: Resolver<Array<ResolversTypes['Planet']>, ParentType, ContextType, RequireFields<QuerySearchPlanetsArgs, 'name'>>;
